...
function d(e) {
	for (var t, n = c(e), a = n[0], o = n[1], s = new i(u(e, a, o)), l = 0, d = o > 0 ? a - 4 : a, f = 0; f < d; f += 4) t = r[e.charCodeAt(f)] << 18 | r[e.charCodeAt(f + 1)] << 12 | r[e.charCodeAt(f + 2)] << 6 | r[e.charCodeAt(f + 3)], s[l++] = t >> 16 & 255, s[l++] = t >> 8 & 255, s[l++] = t & 255;
...
h.read = function(e, t, n, r, i) {
	...
	e.Buffer = d, e.SlowBuffer = ne, e.INSPECT_MAX_BYTES = 50;
	let a = 2147483647;
	e.kMaxLength = a;
	...
	function f(e, t, n) {
		...
		if (Z(e, s) || e && Z(e.buffer, s) || c !== void 0 && (Z(e, c) || e && Z(e.buffer, c))) return y(e, t, n);
	...
	function _(e, t) {
		...
		let n = x(e, t) | 0, r = u(n), i = r.write(e, t);
		return i !== n && (r = r.slice(0, i)), r;
	}
	function v(e) {
		let t = e.length < 0 ? 0 : b(e.length) | 0, n = u(t);
	...
	d.prototype.swap16 = function() {
		...
		return this === e || d.compare(this, e) === 0;
	...
	function w(e, t, n, r, i) {
		...
		if (typeof t == "string" && (t = d.from(t, r)), d.isBuffer(t)) return t.length === 0 ? -1 : T(e, t, n, r, i);
		if (typeof t == "number") return t &= 255, typeof o.prototype.indexOf == "function" ? i ? o.prototype.indexOf.call(e, t, n) : o.prototype.lastIndexOf.call(e, t, n) : T(e, [t], n, r, i);
...
var g = e.Buffer;
e.Blob, e.BlobOptions, e.Buffer, e.File, e.FileOptions, e.INSPECT_MAX_BYTES, e.SlowBuffer, e.TranscodeEncoding, e.atob, e.btoa, e.constants, e.isAscii, e.isUtf8, e.kMaxLength, e.kStringMaxLength, e.resolveObjectURL, e.transcode;
//#endregion
export { g as t };
