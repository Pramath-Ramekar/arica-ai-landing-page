import { n as e, t } from "./dist-DdQ7ABni.js";
//#region node_modules/@splinetool/runtime/build/snippets/hana-82e9eb82a79dead4/js-imports.js
e();
async function n(e) {
...
var i = 0, a = 1e6, o = 2, s = 3e4;
function c(e) {
	if (typeof e.requestVideoFrameCallback != "function") {
		e.hanaClockBase = ++i * a;
		return;
	}
	e.hanaPresentedFrames = ++i;
	let t = () => {
		e.hanaDisposed || (e.hanaPresentedFrames = ++i);
	};
	e.addEventListener("seeked", t);
	let n = () => {
		t(), !e.hanaDisposed && (e.hanaFrameCallback = e.requestVideoFrameCallback(n));
	};
	e.hanaFrameCallback = e.requestVideoFrameCallback(n);
}
function l(e) {
	let t = e.hanaPresentedFrames;
	return t === void 0 ? e.hanaClockBase + e.currentTime : t;
}
function u(e, t) {
	e.hanaObjectUrl = URL.createObjectURL(t), e.src = e.hanaObjectUrl;
}
function ee(e) {
	if (e.hanaDisposed) return;
	e.hanaDisposed = !0;
	let t = e.hanaFrameCallback;
	t !== void 0 && (e.hanaFrameCallback = void 0, typeof e.cancelVideoFrameCallback == "function" && e.cancelVideoFrameCallback(t));
	let n = e.hanaObjectUrl;
	n !== void 0 && (e.hanaObjectUrl = void 0, URL.revokeObjectURL(n)), e.pause(), e.removeAttribute("src"), e.load();
}
function te(e) {
	let t = (t) => {
		let n = e.error;
		return Error(n === null ? t : `${t} (code ${n.code}: ${n.message})`);
	}, n = (n) => {
		let r = t(n);
		return ee(e), r;
	};
	return e.error === null ? e.readyState >= o ? Promise.resolve(e) : new Promise((t, r) => {
		let i = setTimeout(() => a(r, n("video timed out before presenting a frame")), s), a = (t, n) => {
			clearTimeout(i), e.removeEventListener("loadeddata", o), e.removeEventListener("canplay", o), e.removeEventListener("error", c), t(n);
		}, o = () => a(t, e), c = () => a(r, n("video failed to load"));
		e.addEventListener("loadeddata", o), e.addEventListener("canplay", o), e.addEventListener("error", c);
	}) : Promise.reject(n("video failed to load"));
}
function ne(e) {
	return e.preload = "auto", e.autoplay = !0, e.loop = !0, e.muted = !0, e.playsInline = !0, e.currentTime = .01, e.load(), e.onloadeddata = () => {
		e.muted = !0;
		let t = e.play();
		t !== void 0 && t.then((e) => {}).catch(() => {
			e.play();
		}).finally(() => {
			e.pause();
		});
...
async function re(e) {
	...
	return u(t, new Blob([e])), ne(t);
}
async function ie(e) {
	let t = document.createElement("video");
	return t.crossOrigin = "anonymous", t.src = e, ne(t);
}
//#endregion
//#region node_modules/@splinetool/runtime/build/hana-ui.js
var d = class e {
	static __wrap(t) {
	...
	free() {
		...
		$.__wbg_devicelostpromise_free(e, 0);
	}
	wait() {
		let e = this.__destroy_into_raw();
		return J($.devicelostpromise_wait(e));
	}
};
...
var f = class e {
	...
	free() {
		let e = this.__destroy_into_raw();
		$.__wbg_engine_free(e, 0);
	}
	static create(e, t, n) {
		return J($.engine_create(x(e), x(t), n));
	}
	getDeviceLostPromise() {
		let e = $.engine_getDeviceLostPromise(this.__wbg_ptr);
		return e === 0 ? void 0 : d.__wrap(e);
	}
	getGpuFrameTimeMs() {
		try {
			let n = $.__wbindgen_add_to_stack_pointer(-16);
			$.engine_getGpuFrameTimeMs(n, this.__wbg_ptr);
			var e = k().getInt32(n + 0, !0), t = k().getFloat64(n + 8, !0);
			return e === 0 ? void 0 : t;
		} finally {
	...
	isWebgpu() {
		return $.engine_isWebgpu(this.__wbg_ptr) !== 0;
	}
	onFrame(e) {
		$.engine_onFrame(this.__wbg_ptr, !W(e), W(e) ? 0 : e);
	}
	removeTexture(e) {
		$.engine_removeTexture(this.__wbg_ptr, x(e));
	}
	renderRegion(e, t, n) {
		let r = $.engine_renderRegion(this.__wbg_ptr, x(e), x(t), n);
		return p.__wrap(r);
	}
	reset(e) {
		$.engine_reset(this.__wbg_ptr, x(e));
	}
	resize(e, t) {
		$.engine_resize(this.__wbg_ptr, x(e), t);
	}
	samplePixels(e, t) {
		let n = $.engine_samplePixels(this.__wbg_ptr, x(e), x(t));
		return p.__wrap(n);
	}
};
...
var p = class e {
	...
	free() {
		let e = this.__destroy_into_raw();
		$.__wbg_pixelreadpromise_free(e, 0);
	}
	wait() {
		let e = this.__destroy_into_raw();
		return J($.pixelreadpromise_wait(e));
	}
};
...
var ae = class {
	...
	free() {
		let e = this.__destroy_into_raw();
		$.__wbg_scenecontroller_free(e, 0);
	}
	get is_play_mode() {
		return $.__wbg_get_scenecontroller_is_play_mode(this.__wbg_ptr) !== 0;
	}
	get needs_video_update() {
		return $.__wbg_get_scenecontroller_needs_video_update(this.__wbg_ptr) !== 0;
	}
	get show_pixel_grid() {
		return $.__wbg_get_scenecontroller_show_pixel_grid(this.__wbg_ptr) !== 0;
	}
	addEmojiArt(e, t) {
		let n = K(e, $.__wbindgen_export, $.__wbindgen_export2), r = Q;
		$.scenecontroller_addEmojiArt(this.__wbg_ptr, n, r, x(t));
	}
	addImage(e, t) {
		$.scenecontroller_addImage(this.__wbg_ptr, x(e), x(t));
	}
	addLocalFont(e, t, n, r, i) {
		var a = W(n) ? 0 : K(n, $.__wbindgen_export, $.__wbindgen_export2), o = Q, s = W(r) ? 0 : K(r, $.__wbindgen_export, $.__wbindgen_export2), c = Q, l = W(i) ? 0 : K(i, $.__wbindgen_export, $.__wbindgen_export2), u = Q;
		return $.scenecontroller_addLocalFont(this.__wbg_ptr, x(e), x(t), a, o, s, c, l, u) !== 0;
	}
	addModel3DGeometry(e, t) {
		$.scenecontroller_addModel3DGeometry(this.__wbg_ptr, x(e), x(t));
	}
	addVideo(e, t) {
		$.scenecontroller_addVideo(this.__wbg_ptr, x(e), x(t));
	}
	addWebFont(e, t) {
		let n = K(t, $.__wbindgen_export, $.__wbindgen_export2), r = Q;
		return J($.scenecontroller_addWebFont(this.__wbg_ptr, x(e), n, r));
	}
	applyDeltaToVectorVertexPositionSelection(e, t, n) {
		return J($.scenecontroller_applyDeltaToVectorVertexPositionSelection(this.__wbg_ptr, x(e), x(t), x(n)));
	}
	axisAlignedBoundingBox(e) {
		return J($.scenecontroller_axisAlignedBoundingBox(this.__wbg_ptr, x(e)));
	}
	boundingBox() {
		return J($.scenecontroller_boundingBox(this.__wbg_ptr));
	}
	boxIntersectsObjects(e, t, n, r, i) {
		try {
			let c = $.__wbindgen_add_to_stack_pointer(-16);
			$.scenecontroller_boxIntersectsObjects(c, this.__wbg_ptr, x(e), x(t), n, r, W(i) ? 0 : x(i));
			var a = k().getInt32(c + 0, !0), o = k().getInt32(c + 4, !0), s = w(a, o).slice();
			return $.__wbindgen_export4(a, o * 4, 4), s;
		} finally {
			$.__wbindgen_add_to_stack_pointer(16);
		}
	}
	calcTextAutoSize(e, t) {
		return J($.scenecontroller_calcTextAutoSize(this.__wbg_ptr, x(e), W(t) ? 2 ** 53 - 1 : Math.fround(t)));
	}
	centerPencilData(e) {
		return J($.scenecontroller_centerPencilData(this.__wbg_ptr, x(e)));
	}
	centerVectorData() {
		return J($.scenecontroller_centerVectorData(this.__wbg_ptr));
	}
	clearVideoExportFrame(e) {
		$.scenecontroller_clearVideoExportFrame(this.__wbg_ptr, x(e));
	}
	clearVideoExportFrames() {
		$.scenecontroller_clearVideoExportFrames(this.__wbg_ptr);
	}
	figmaVectorToVecNet(e, t) {
		return J($.scenecontroller_figmaVectorToVecNet(this.__wbg_ptr, x(e), x(t)));
	}
	flattenShape(e) {
		return J($.scenecontroller_flattenShape(this.__wbg_ptr, x(e)));
	}
	flushLayout(e) {
		try {
			let i = $.__wbindgen_add_to_stack_pointer(-16);
			$.scenecontroller_flushLayout(i, this.__wbg_ptr, x(e));
			var t = k().getInt32(i + 0, !0), n = k().getInt32(i + 4, !0), r = w(t, n).slice();
			return $.__wbindgen_export4(t, n * 4, 4), r;
		} finally {
			$.__wbindgen_add_to_stack_pointer(16);
		}
	}
	getCurrentFrameIndex() {
		let e = $.scenecontroller_getCurrentFrameIndex(this.__wbg_ptr);
		return e === 2 ** 53 - 1 ? void 0 : e;
	}
	getTotalFramesAmount() {
		return $.scenecontroller_getTotalFramesAmount(this.__wbg_ptr) >>> 0;
	}
	getUpdatedPencilData() {
		return J($.scenecontroller_getUpdatedPencilData(this.__wbg_ptr));
	}
	getUpdatedVecNetData() {
		return J($.scenecontroller_getUpdatedVecNetData(this.__wbg_ptr));
	}
	getVectorBoxSelectionBoundsAndLocalMatrix(e) {
		return J($.scenecontroller_getVectorBoxSelectionBoundsAndLocalMatrix(this.__wbg_ptr, e));
	}
	getVectorCursor() {
		return J($.scenecontroller_getVectorCursor(this.__wbg_ptr));
	}
	getVectorEditMode() {
		return J($.scenecontroller_getVectorEditMode(this.__wbg_ptr));
	}
	getVectorEditingState() {
		return J($.scenecontroller_getVectorEditingState(this.__wbg_ptr));
	}
	getVectorSelectedVerts() {
		return J($.scenecontroller_getVectorSelectedVerts(this.__wbg_ptr));
	}
	getVectorSelectionCount() {
		return $.scenecontroller_getVectorSelectionCount(this.__wbg_ptr) >>> 0;
	}
	hasFontAssetsChanges() {
		return $.scenecontroller_hasFontAssetsChanges(this.__wbg_ptr) !== 0;
	}
	hasSingleVectorSelectedSegment() {
		return $.scenecontroller_hasSingleVectorSelectedSegment(this.__wbg_ptr) !== 0;
	}
	instanceRootOf(e) {
		return J($.scenecontroller_instanceRootOf(this.__wbg_ptr, x(e)));
	}
	intersectsObject(e, t, n, r) {
		return $.scenecontroller_intersectsObject(this.__wbg_ptr, x(e), x(t), W(n) ? 2 ** 53 - 1 : Math.fround(n), W(r) ? 16777215 : +!!r) !== 0;
	}
	intersectsObjects(e, t, n) {
		try {
			let o = $.__wbindgen_add_to_stack_pointer(-16);
			$.scenecontroller_intersectsObjects(o, this.__wbg_ptr, x(e), W(t) ? 16777215 : +!!t, W(n) ? 2 ** 53 - 1 : Math.fround(n));
			var r = k().getInt32(o + 0, !0), i = k().getInt32(o + 4, !0), a = w(r, i).slice();
			return $.__wbindgen_export4(r, i * 4, 4), a;
		} finally {
			$.__wbindgen_add_to_stack_pointer(16);
		}
	}
	isEditedVectorEmpty() {
		return $.scenecontroller_isEditedVectorEmpty(this.__wbg_ptr) !== 0;
	}
	isObjectInViewport(e) {
		return $.scenecontroller_isObjectInViewport(this.__wbg_ptr, x(e)) !== 0;
	}
	isUiFontLoaded() {
		return $.scenecontroller_isUiFontLoaded(this.__wbg_ptr) !== 0;
	}
	isVectorBoxSelectAllowed() {
		return $.scenecontroller_isVectorBoxSelectAllowed(this.__wbg_ptr) !== 0;
	}
	isVectorPointUnderCursor(e) {
		return $.scenecontroller_isVectorPointUnderCursor(this.__wbg_ptr, x(e)) !== 0;
	}
	layout() {
		$.scenecontroller_layout(this.__wbg_ptr);
	}
	layoutFromResize() {
		try {
			let r = $.__wbindgen_add_to_stack_pointer(-16);
			$.scenecontroller_layoutFromResize(r, this.__wbg_ptr);
			var e = k().getInt32(r + 0, !0), t = k().getInt32(r + 4, !0), n = w(e, t).slice();
			return $.__wbindgen_export4(e, t * 4, 4), n;
		} finally {
			$.__wbindgen_add_to_stack_pointer(16);
		}
	}
	markNeedsLayoutResolve(e) {
		$.scenecontroller_markNeedsLayoutResolve(this.__wbg_ptr, x(e));
	}
	measureTextNaturalSize(e) {
		return J($.scenecontroller_measureTextNaturalSize(this.__wbg_ptr, x(e)));
	}
	model3DAnimationClipIndex(e) {
		let t = $.scenecontroller_model3DAnimationClipIndex(this.__wbg_ptr, x(e));
		return t === 2 ** 53 - 1 ? void 0 : t;
	}
	model3DAnimationIsPlaying(e) {
		return $.scenecontroller_model3DAnimationIsPlaying(this.__wbg_ptr, x(e)) !== 0;
	}
	model3DAnimationLocalTime(e) {
		let t = $.scenecontroller_model3DAnimationLocalTime(this.__wbg_ptr, x(e));
		return t === 2 ** 53 - 1 ? void 0 : t;
	}
	moveVectorSelectionByDelta(e) {
		$.scenecontroller_moveVectorSelectionByDelta(this.__wbg_ptr, x(e));
	}
	objectAlignedBoundingBox(e) {
		return J($.scenecontroller_objectAlignedBoundingBox(this.__wbg_ptr, x(e)));
	}
	objectData(e) {
		return J($.scenecontroller_objectData(this.__wbg_ptr, x(e)));
	}
	objectLocalMatrix(e) {
		return J($.scenecontroller_objectLocalMatrix(this.__wbg_ptr, x(e)));
	}
	objectWorldMatrix(e) {
		return J($.scenecontroller_objectWorldMatrix(this.__wbg_ptr, x(e)));
	}
	objectWorldMatrixWithChildrenOffset(e) {
		return J($.scenecontroller_objectWorldMatrixWithChildrenOffset(this.__wbg_ptr, x(e)));
	}
	onKeyDown(e) {
		let t = K(e, $.__wbindgen_export, $.__wbindgen_export2), n = Q;
		$.scenecontroller_onKeyDown(this.__wbg_ptr, t, n);
	}
	onKeyUp(e) {
		let t = K(e, $.__wbindgen_export, $.__wbindgen_export2), n = Q;
		$.scenecontroller_onKeyUp(this.__wbg_ptr, t, n);
	}
	onPointerDown(e, t, n) {
		$.scenecontroller_onPointerDown(this.__wbg_ptr, x(e), t, n);
	}
	onPointerEnter() {
		$.scenecontroller_onPointerEnter(this.__wbg_ptr);
	}
	onPointerLeave() {
		$.scenecontroller_onPointerLeave(this.__wbg_ptr);
	}
	onPointerMove(e, t, n) {
		$.scenecontroller_onPointerMove(this.__wbg_ptr, x(e), t, n);
	}
	onPointerUp(e, t, n) {
		$.scenecontroller_onPointerUp(this.__wbg_ptr, x(e), t, n);
	}
	outermostInstanceRootOf(e) {
		return J($.scenecontroller_outermostInstanceRootOf(this.__wbg_ptr, x(e)));
	}
	parentAlignedBoundingBox(e, t) {
		return J($.scenecontroller_parentAlignedBoundingBox(this.__wbg_ptr, x(e), x(t)));
	}
	parseSvgPath(e, t) {
		let n = K(e, $.__wbindgen_export, $.__wbindgen_export2), r = Q;
		return J($.scenecontroller_parseSvgPath(this.__wbg_ptr, n, r, t));
	}
	pencilShiftDown() {
		$.scenecontroller_pencilShiftDown(this.__wbg_ptr);
	}
	pencilShiftUp() {
		$.scenecontroller_pencilShiftUp(this.__wbg_ptr);
	}
	pendingAssetLoads() {
		return $.scenecontroller_pendingAssetLoads(this.__wbg_ptr) >>> 0;
	}
	playInEditorFrame(e) {
		$.scenecontroller_playInEditorFrame(this.__wbg_ptr, x(e));
	}
	present(e, t) {
		$.scenecontroller_present(this.__wbg_ptr, W(e) ? 0 : x(e), W(t) ? 16777215 : +!!t);
	}
	previewTransition(e, t, n) {
		$.scenecontroller_previewTransition(this.__wbg_ptr, x(e), W(t) ? 0 : x(t), x(n));
	}
	projectionEffectBoundingBox(e) {
		return J($.scenecontroller_projectionEffectBoundingBox(this.__wbg_ptr, x(e)));
	}
	readVectorCornerRadiiForSelection(e, t) {
		return J($.scenecontroller_readVectorCornerRadiiForSelection(this.__wbg_ptr, x(e), x(t)));
	}
	readVectorCornerSmoothing(e) {
		return $.scenecontroller_readVectorCornerSmoothing(this.__wbg_ptr, x(e));
	}
	readVectorVertexPositionsForSelection(e, t) {
		return J($.scenecontroller_readVectorVertexPositionsForSelection(this.__wbg_ptr, x(e), x(t)));
	}
	reanchorObject(e) {
		$.scenecontroller_reanchorObject(this.__wbg_ptr, x(e));
	}
	resetAllStates(e, t) {
		let n = mt(t, $.__wbindgen_export), r = Q;
		$.scenecontroller_resetAllStates(this.__wbg_ptr, W(e) ? 0 : x(e), n, r);
	}
	resizeGroup(e, t, n) {
		try {
			let o = $.__wbindgen_add_to_stack_pointer(-16);
			$.scenecontroller_resizeGroup(o, this.__wbg_ptr, x(e), t, n);
			var r = k().getInt32(o + 0, !0), i = k().getInt32(o + 4, !0), a = w(r, i).slice();
			return $.__wbindgen_export4(r, i * 4, 4), a;
		} finally {
			$.__wbindgen_add_to_stack_pointer(16);
	...
	saveVectorSelectionInitialPositions() {
		$.scenecontroller_saveVectorSelectionInitialPositions(this.__wbg_ptr);
	}
	screenToWorld(e) {
		return J($.scenecontroller_screenToWorld(this.__wbg_ptr, x(e)));
	}
	seekVideos(e) {
		return J($.scenecontroller_seekVideos(this.__wbg_ptr, e));
	}
	setBytesForVectorCornerRadiusSelection(e, t, n) {
		return J($.scenecontroller_setBytesForVectorCornerRadiusSelection(this.__wbg_ptr, x(e), x(t), n));
	}
	setBytesForVectorCornerSmoothing(e, t) {
		return J($.scenecontroller_setBytesForVectorCornerSmoothing(this.__wbg_ptr, x(e), t));
	}
	setBytesForVectorVertexPositionSelection(e, t, n, r) {
		return J($.scenecontroller_setBytesForVectorVertexPositionSelection(this.__wbg_ptr, x(e), x(t), n, r));
	}
	setModel3DAnimation(e, t, n) {
		$.scenecontroller_setModel3DAnimation(this.__wbg_ptr, x(e), W(t) ? 2 ** 53 - 1 : t >>> 0, n);
	}
	setModel3DAnimationLocalTime(e, t) {
		$.scenecontroller_setModel3DAnimationLocalTime(this.__wbg_ptr, x(e), t);
	}
	setPresentationPadding(e) {
		$.scenecontroller_setPresentationPadding(this.__wbg_ptr, x(e));
	}
	setShowPixelGrid(e) {
		$.scenecontroller_setShowPixelGrid(this.__wbg_ptr, e);
	}
	setVectorEditingState(e) {
		try {
			$.scenecontroller_setVectorEditingState(this.__wbg_ptr, $e(e));
		} finally {
			H[q++] = void 0;
		}
	}
	setVectorTool(e) {
		$.scenecontroller_setVectorTool(this.__wbg_ptr, x(e));
	}
	setVideoExportFrame(e, t) {
		$.scenecontroller_setVideoExportFrame(this.__wbg_ptr, x(e), x(t));
	}
	snapVectorResizeHandle(e, t, n) {
		return J($.scenecontroller_snapVectorResizeHandle(this.__wbg_ptr, x(e), t, n));
	}
	start() {
		$.scenecontroller_start(this.__wbg_ptr);
	}
	startPencil(e, t, n) {
		$.scenecontroller_startPencil(this.__wbg_ptr, x(e), t, x(n));
	}
	startVectorEditing(e, t) {
		$.scenecontroller_startVectorEditing(this.__wbg_ptr, x(e), t);
	}
	stopInEditorFrame() {
		$.scenecontroller_stopInEditorFrame(this.__wbg_ptr);
	}
	stopPencil() {
		$.scenecontroller_stopPencil(this.__wbg_ptr);
	}
	stopPresenting() {
		$.scenecontroller_stopPresenting(this.__wbg_ptr);
	}
	stopPreviewTransition() {
		$.scenecontroller_stopPreviewTransition(this.__wbg_ptr);
	}
	stopVectorEditing() {
		$.scenecontroller_stopVectorEditing(this.__wbg_ptr);
	}
	strokeShape(e) {
		return J($.scenecontroller_strokeShape(this.__wbg_ptr, x(e)));
	}
	switchScene(e) {
		$.scenecontroller_switchScene(this.__wbg_ptr, x(e));
	}
	transformBoundingBoxByAlignObject(e, t, n, r) {
		return J($.scenecontroller_transformBoundingBoxByAlignObject(this.__wbg_ptr, x(e), x(t), x(n), x(r)));
	}
	transformVectorSelection(e, t, n, r) {
		return $.scenecontroller_transformVectorSelection(this.__wbg_ptr, x(e), x(t), n, r) !== 0;
	}
	triggerEventForObjectIds(e) {
		let t = mt(e, $.__wbindgen_export), n = Q;
		$.scenecontroller_triggerEventForObjectIds(this.__wbg_ptr, t, n);
	}
	updateByOp(e) {
		$.scenecontroller_updateByOp(this.__wbg_ptr, x(e));
	}
	updateCached() {
		$.scenecontroller_updateCached(this.__wbg_ptr);
	}
	updateCamera(e) {
		$.scenecontroller_updateCamera(this.__wbg_ptr, x(e));
	}
	updateComponents(e) {
		$.scenecontroller_updateComponents(this.__wbg_ptr, x(e));
	}
	updatePublish(e) {
		$.scenecontroller_updatePublish(this.__wbg_ptr, x(e));
	}
	updateSceneOp(e) {
		$.scenecontroller_updateSceneOp(this.__wbg_ptr, x(e));
	}
	updateUiShapes(e) {
		$.scenecontroller_updateUiShapes(this.__wbg_ptr, x(e));
	}
	vectorAllowMultiSelect(e) {
		$.scenecontroller_vectorAllowMultiSelect(this.__wbg_ptr, e);
	}
	vectorBoxSelect(e, t) {
		$.scenecontroller_vectorBoxSelect(this.__wbg_ptr, x(e), x(t));
	}
	vectorClearSnapping() {
		$.scenecontroller_vectorClearSnapping(this.__wbg_ptr);
	}
	vectorDeleteSelection(e) {
		$.scenecontroller_vectorDeleteSelection(this.__wbg_ptr, e);
	}
	vectorResize(e, t) {
		return J($.scenecontroller_vectorResize(this.__wbg_ptr, x(e), x(t)));
	}
	vectorResizeWithCornerRadii(e, t, n) {
		return J($.scenecontroller_vectorResizeWithCornerRadii(this.__wbg_ptr, x(e), x(t), n));
	}
	vectorSetIsAltPressed(e) {
		$.scenecontroller_vectorSetIsAltPressed(this.__wbg_ptr, e);
	}
	vectorSetIsSnapping(e) {
		$.scenecontroller_vectorSetIsSnapping(this.__wbg_ptr, e);
	}
	vectorSetIsSnappingControlAngles(e) {
		$.scenecontroller_vectorSetIsSnappingControlAngles(this.__wbg_ptr, e);
	}
	vectorStopContinueSubpath() {
		$.scenecontroller_vectorStopContinueSubpath(this.__wbg_ptr);
	}
	videoFillSources(e) {
		return J($.scenecontroller_videoFillSources(this.__wbg_ptr, x(e)));
	}
	worldToScreen(e) {
		return J($.scenecontroller_worldToScreen(this.__wbg_ptr, x(e)));
	}
	set is_play_mode(e) {
		$.__wbg_set_scenecontroller_is_play_mode(this.__wbg_ptr, e);
	}
	set needs_video_update(e) {
		$.__wbg_set_scenecontroller_needs_video_update(this.__wbg_ptr, e);
	}
	set show_pixel_grid(e) {
		$.__wbg_set_scenecontroller_show_pixel_grid(this.__wbg_ptr, e);
	}
};
Symbol.dispose && (ae.prototype[Symbol.dispose] = ae.prototype.free);
function oe(e, t, n, r, i) {
	return J($.addRealizedChild(x(e), x(t), x(n), x(r), x(i)));
}
function se(e, t, n, r, i) {
	return J($.componentInstanceRefreshOps(x(e), x(t), x(n), x(r), x(i)));
}
function ce(e, t, n, r) {
	return J($.dematerializeInstance(x(e), x(t), x(n), x(r)));
}
function le(e, t, n, r) {
	return J($.duplicateComponentInstance(x(e), x(t), x(n), x(r)));
}
function ue(e, t, n, r, i) {
	return J($.overrideForRealizedEdit(x(e), x(t), x(n), x(r), x(i)));
}
function de(e, t, n) {
	return J($.realizeComponentInstance(x(e), x(t), x(n)));
}
function fe(e, t, n, r) {
	return J($.removeRealizedNode(x(e), x(t), x(n), x(r)));
}
function pe() {
	$.web_init();
}
	...
	return {
		...
		"./hana_bg.js": {
			...
			__wbg_WorkerGlobalScope_5d19ebc889ff397e: function(e) {
				let t = B(e).WorkerGlobalScope;
				return x(t);
			},
			__wbg___wbindgen_bigint_get_as_i64_38130e98eecd467d: function(e, t) {
				let n = B(t), r = typeof n == "bigint" ? n : void 0;
				k().setBigInt64(e + 8, W(r) ? BigInt(0) : r, !0), k().setInt32(e + 0, !W(r), !0);
			},
			__wbg___wbindgen_boolean_get_1a45e2c38d4d41b9: function(e) {
				let t = B(e), n = typeof t == "boolean" ? t : void 0;
				return W(n) ? 16777215 : +!!n;
			},
			__wbg___wbindgen_debug_string_0accd80f45e5faa2: function(e, t) {
				let n = K(S(B(t)), $.__wbindgen_export, $.__wbindgen_export2), r = Q;
			...
			__wbg___wbindgen_number_get_9bb1761122181af2: function(e, t) {
				let n = B(t), r = typeof n == "number" ? n : void 0;
				k().setFloat64(e + 8, W(r) ? 0 : r, !0), k().setInt32(e + 0, !W(r), !0);
			},
			__wbg___wbindgen_string_get_72bdf95d3ae505b1: function(e, t) {
				let n = B(t), r = typeof n == "string" ? n : void 0;
				var i = W(r) ? 0 : K(r, $.__wbindgen_export, $.__wbindgen_export2), a = Q;
			...
			__wbg_addEventListener_5593b0efd622abd6: function() {
				return V(function(e, t, n, r, i) {
					B(e).addEventListener(F(t, n), B(r), B(i));
				}, arguments);
			},
			__wbg_arrayBuffer_05927079aabe6d46: function() {
				return V(function(e) {
					return x(B(e).arrayBuffer());
				}, arguments);
			},
			...
			__wbg_call_8a89609d89f6608a: function() {
				return V(function(e, t) {
					return x(B(e).call(B(t)));
				}, arguments);
			},
			__wbg_call_9c758de292015997: function() {
				return V(function(e, t, n) {
					return x(B(e).call(B(t), B(n)));
				}, arguments);
			},
			__wbg_clearBufferfv_2e2858bd8bcf1715: function(e, t, n, r, i) {
				B(e).clearBufferfv(t >>> 0, n, C(r, i));
			},
			__wbg_clearBufferiv_e356514eb1d165fe: function(e, t, n, r, i) {
				B(e).clearBufferiv(t >>> 0, n, it(r, i));
			},
			__wbg_compileShader_8810a4868b23621b: function(e, t) {
				B(e).compileShader(B(t));
			},
			...
			__wbg_createPipelineLayout_2c8cd4528b06c108: function(e, t) {
				return x(B(e).createPipelineLayout(B(t)));
			},
			__wbg_createProgram_b48c3323af547213: function(e) {
				let t = B(e).createProgram();
				return W(t) ? 0 : x(t);
			},
			...
			__wbg_createTexture_1bac74c999b8a48e: function() {
				return V(function(e, t) {
					return x(B(e).createTexture(B(t)));
				}, arguments);
			},
			__wbg_createTexture_461a3048c40e7175: function(e) {
				let t = B(e).createTexture();
				return W(t) ? 0 : x(t);
			},
			...
			__wbg_description_02485704e69b1e7f: function(e, t) {
				let n = B(t).description, r = K(n, $.__wbindgen_export, $.__wbindgen_export2), i = Q;
			...
			__wbg_dispatchWorkgroups_afb2344298c62227: function(e, t, n, r) {
				B(e).dispatchWorkgroups(t >>> 0, n >>> 0, r >>> 0);
			},
			__wbg_displayHeight_465673c1823a1db3: function(e) {
				return B(e).displayHeight;
			},
			__wbg_displayWidth_73729fd8eb965076: function(e) {
				return B(e).displayWidth;
			},
			__wbg_disposeVideo_c94c1ccd57a63f68: function(e) {
				ee(B(e));
			},
			...
			__wbg_drawArrays_6eb87620c1dcbfb4: function(e, t, n, r) {
				B(e).drawArrays(t >>> 0, n, r);
			},
			__wbg_drawArrays_f332b526550a641e: function(e, t, n, r) {
				B(e).drawArrays(t >>> 0, n, r);
			},
			__wbg_drawBuffersWEBGL_10cdfe87c17cd93f: function(e, t) {
				B(e).drawBuffersWEBGL(B(t));
			},
			__wbg_drawBuffers_c5a9ee312b2d6fa8: function(e, t) {
				B(e).drawBuffers(B(t));
			},
			__wbg_drawElements_23ec4847dad548e0: function(e, t, n, r, i) {
				B(e).drawElements(t >>> 0, n, r >>> 0, i);
			},
			__wbg_drawElements_fe4671e9c358058d: function(e, t, n, r, i) {
				B(e).drawElements(t >>> 0, n, r >>> 0, i);
			},
			__wbg_drawIndexed_d31913e79d58fbac: function(e, t, n, r, i, a) {
				B(e).drawIndexed(t >>> 0, n >>> 0, r >>> 0, i, a >>> 0);
			},
			__wbg_draw_6877f98847e1e36c: function(e, t, n, r, i) {
				B(e).draw(t >>> 0, n >>> 0, r >>> 0, i >>> 0);
			},
			__wbg_duration_d6a6a568a0baf72d: function(e) {
				return B(e).duration;
			},
			__wbg_enableVertexAttribArray_cc09a0312b6adee5: function(e, t) {
				B(e).enableVertexAttribArray(t >>> 0);
			},
			...
			__wbg_fetch_ce1af4d1b59a60be: function(e, t) {
				return x(B(e).fetch(B(t)));
			},
			__wbg_finish_4d91de5e927dd13f: function(e, t) {
				return x(B(e).finish(B(t)));
			},
			...
			__wbg_framebufferRenderbuffer_0c9d0e5587497683: function(e, t, n, r, i) {
				B(e).framebufferRenderbuffer(t >>> 0, n >>> 0, r >>> 0, B(i));
			},
			__wbg_framebufferRenderbuffer_599e58ad30dcfeb3: function(e, t, n, r, i) {
				B(e).framebufferRenderbuffer(t >>> 0, n >>> 0, r >>> 0, B(i));
			},
			__wbg_framebufferTexture2D_44caed1725e57636: function(e, t, n, r, i, a) {
				B(e).framebufferTexture2D(t >>> 0, n >>> 0, r >>> 0, B(i), a);
			},
			__wbg_framebufferTexture2D_fbba21b750c2316a: function(e, t, n, r, i, a) {
				B(e).framebufferTexture2D(t >>> 0, n >>> 0, r >>> 0, B(i), a);
			},
			__wbg_from_d300fe49deab18f5: function(e) {
				return x(Array.from(B(e)));
			},
			__wbg_generateMipmap_1403959fc241438f: function(e, t) {
				B(e).generateMipmap(t >>> 0);
			},
			__wbg_generateMipmap_b261c040d5707fe5: function(e, t) {
				B(e).generateMipmap(t >>> 0);
			},
			__wbg_getActiveUniform_3a275fd8fdf7a327: function(e, t, n) {
				let r = B(e).getActiveUniform(B(t), n >>> 0);
				return W(r) ? 0 : x(r);
			},
			...
			__wbg_getContext_469d34698d869fc1: function() {
				return V(function(e, t, n) {
					let r = B(e).getContext(F(t, n));
					return W(r) ? 0 : x(r);
				}, arguments);
			},
			__wbg_getContext_5b39fff76491fded: function() {
				return V(function(e, t, n, r) {
					let i = B(e).getContext(F(t, n), B(r));
					return W(i) ? 0 : x(i);
				}, arguments);
			},
			...
			__wbg_getPreferredCanvasFormat_8b57039d1801a506: function(e) {
				let t = B(e).getPreferredCanvasFormat();
				return (y.indexOf(t) + 1 || 102) - 1;
			},
			__wbg_getProgramInfoLog_2f9cfcecc4f772e1: function(e, t, n) {
				let r = B(t).getProgramInfoLog(B(n));
				var i = W(r) ? 0 : K(r, $.__wbindgen_export, $.__wbindgen_export2), a = Q;
				k().setInt32(e + 4, a, !0), k().setInt32(e + 0, i, !0);
			},
			...
			__wbg_getProgramParameter_08beabb2736d5769: function(e, t, n) {
				return x(B(e).getProgramParameter(B(t), n >>> 0));
			},
			...
			__wbg_getShaderInfoLog_510365af17f29a35: function(e, t, n) {
				let r = B(t).getShaderInfoLog(B(n));
				var i = W(r) ? 0 : K(r, $.__wbindgen_export, $.__wbindgen_export2), a = Q;
				k().setInt32(e + 4, a, !0), k().setInt32(e + 0, i, !0);
			},
			...
			__wbg_getSupportedExtensions_7a31b3412a25d9ba: function(e) {
				let t = B(e).getSupportedExtensions();
				return W(t) ? 0 : x(t);
			},
			__wbg_getUniformLocation_010256f946f9a865: function(e, t, n, r) {
				let i = B(e).getUniformLocation(B(t), F(n, r));
				return W(i) ? 0 : x(i);
			},
			...
			__wbg_get_index_ab123d64c89e3156: function(e, t) {
				return B(e)[t >>> 0];
			},
			...
			__wbg_has_0c97053e877f47cc: function(e, t, n) {
				return B(e).has(F(t, n));
			},
			__wbg_has_73740b27f436fed3: function() {
				return V(function(e, t) {
					return Reflect.has(B(e), B(t));
				}, arguments);
			},
			...
			__wbg_instanceof_GpuOutOfMemoryError_6429c750997f1c8d: function(e) {
				let t;
				try {
					t = B(e) instanceof GPUOutOfMemoryError;
				} catch {
					t = !1;
				}
				return t;
			...
			__wbg_instanceof_GpuValidationError_75fa3611f065f4df: function(e) {
				let t;
				try {
					t = B(e) instanceof GPUValidationError;
				} catch {
					t = !1;
				}
				return t;
			...
			__wbg_instanceof_HtmlVideoElement_95590e1ff107ba83: function(e) {
				let t;
				try {
					t = B(e) instanceof HTMLVideoElement;
				} catch {
					t = !1;
				}
				return t;
			...
			__wbg_instanceof_WebGl2RenderingContext_39d13e3f953130c7: function(e) {
				let t;
				try {
					t = B(e) instanceof WebGL2RenderingContext;
				} catch {
					t = !1;
				}
				return t;
			...
			__wbg_invalidateFramebuffer_6b8dae55a3debb1d: function() {
				return V(function(e, t, n) {
					B(e).invalidateFramebuffer(t >>> 0, B(n));
				}, arguments);
			},
			...
			__wbg_label_7ed42f25f841996b: function(e, t) {
				let n = B(t).label, r = K(n, $.__wbindgen_export, $.__wbindgen_export2), i = Q;
				k().setInt32(e + 4, i, !0), k().setInt32(e + 0, r, !0);
			},
			__wbg_length_280688879ee7deb5: function(e) {
				return B(e).length;
			},
			...
			__wbg_loadImageFromUrl_50be99dbf040255b: function(e, t) {
				let n, i;
				try {
					return n = e, i = t, x(r(F(e, t)));
				} finally {
					$.__wbindgen_export4(n, i, 1);
				}
			},
			...
			__wbg_minStorageBufferOffsetAlignment_3248ed00dcdbf79f: function(e) {
				return B(e).minStorageBufferOffsetAlignment;
			},
			__wbg_minUniformBufferOffsetAlignment_3b9fa4caae03e903: function(e) {
				return B(e).minUniformBufferOffsetAlignment;
			},
			__wbg_name_b7fa2500fc153b89: function(e, t) {
				let n = B(t).name, r = K(n, $.__wbindgen_export, $.__wbindgen_export2), i = Q;
				k().setInt32(e + 4, i, !0), k().setInt32(e + 0, r, !0);
			},
			...
			__wbg_new_227d7c05414eb861: function() {
				return x(/* @__PURE__ */ Error());
			},
			__wbg_new_3b242422c588a8f3: function() {
				return V(function(e, t) {
					return x(new OffscreenCanvas(e >>> 0, t >>> 0));
				}, arguments);
			},
			__wbg_new_578aeef4b6b94378: function(e) {
				return x(new Uint8Array(B(e)));
			},
			__wbg_new_b682b81e8eaaf027: function(e, t) {
				try {
					var n = {
						a: e,
						b: t
					};
					return x(new Promise((e, t) => {
						let r = n.a;
						n.a = 0;
						try {
							return we(r, n.b, e, t);
			...
			__wbg_new_from_slice_18fa1f71286d66b8: function(e, t) {
				return x(new Uint8Array(D(e, t)));
			},
			__wbg_new_from_slice_3c93d0bc613de8f0: function(e, t) {
				return x(new Float64Array(nt(e, t)));
			},
			__wbg_new_from_slice_47be4219028de35d: function(e, t) {
				return x(new Uint32Array(E(e, t)));
			},
			__wbg_new_from_slice_956df4f769fb782c: function(e, t) {
				return x(new Float32Array(C(e, t)));
			},
			...
			__wbg_new_with_byte_offset_and_length_d836f26d916dd9ad: function(e, t, n) {
				return x(new Uint8Array(B(e), t >>> 0, n >>> 0));
			},
			__wbg_new_with_length_36a4998e27b014c5: function(e) {
				return x(new Uint8Array(e >>> 0));
			},
			__wbg_new_with_length_b4a87ccced374381: function(e) {
				return x(new Float64Array(e >>> 0));
			},
			__wbg_new_with_str_and_init_bcd02b79a793d27f: function() {
				return V(function(e, t, n) {
					return x(new Request(F(e, t), B(n)));
				}, arguments);
			},
			...
			__wbg_onSubmittedWorkDone_270d6b5a45520e79: function(e) {
				return x(B(e).onSubmittedWorkDone());
			},
			__wbg_open_177ad1dcc06b9106: function() {
				return V(function(e, t, n, r, i, a, o) {
					let s = B(e).open(F(t, n), F(r, i), F(a, o));
					return W(s) ? 0 : x(s);
				}, arguments);
			},
			__wbg_open_feb75fe4d9971c50: function() {
				return V(function(e, t, n, r, i) {
					let a = B(e).open(F(t, n), F(r, i));
					return W(a) ? 0 : x(a);
				}, arguments);
			},
			__wbg_ownKeys_0587b8fe286a40e6: function() {
				return V(function(e) {
					return x(Reflect.ownKeys(B(e)));
				}, arguments);
			},
			...
			__wbg_popErrorScope_8e7f4cbff8b758dd: function(e) {
				return x(B(e).popErrorScope());
			},
			__wbg_prototypesetcall_3249fc62a0fafa30: function(e, t, n) {
				Uint8Array.prototype.set.call(D(e, t), B(n));
			},
			__wbg_prototypesetcall_59640349d2c6d881: function(e, t, n) {
				Uint32Array.prototype.set.call(E(e, t), B(n));
			},
			__wbg_provokingVertexWEBGL_0354dc7ad44d69bf: function(e, t) {
				B(e).provokingVertexWEBGL(t >>> 0);
			},
			__wbg_pushErrorScope_fa23d1206bc26dce: function(e, t) {
				B(e).pushErrorScope(Fe[t]);
			},
			...
			__wbg_querySelectorAll_4dcc230a2f8a2498: function() {
				return V(function(e, t, n) {
					return x(B(e).querySelectorAll(F(t, n)));
				}, arguments);
			},
			...
			__wbg_readPixels_a04f5cf5019be695: function() {
				return V(function(e, t, n, r, i, a, o, s) {
					B(e).readPixels(t, n, r, i, a >>> 0, o >>> 0, B(s));
				}, arguments);
			},
			...
			__wbg_readPixels_d00c1cae608273d8: function() {
				return V(function(e, t, n, r, i, a, o, s) {
					B(e).readPixels(t, n, r, i, a >>> 0, o >>> 0, s);
				}, arguments);
			},
			__wbg_readyState_77b1b1db1b8c2a5f: function(e) {
				return B(e).readyState;
			},
			__wbg_reason_b02cd587d1a09948: function(e) {
				let t = B(e).reason;
				return (Pe.indexOf(t) + 1 || 3) - 1;
			},
			__wbg_renderbufferStorageMultisample_75bba97a8e59bc6e: function(e, t, n, r, i, a) {
				B(e).renderbufferStorageMultisample(t >>> 0, n, r >>> 0, i, a);
			},
			__wbg_renderbufferStorage_3f5b0ec8fca2f9f8: function(e, t, n, r, i) {
				B(e).renderbufferStorage(t >>> 0, n >>> 0, r, i);
			},
			__wbg_renderbufferStorage_c34a47cacbbc5fff: function(e, t, n, r, i) {
				B(e).renderbufferStorage(t >>> 0, n >>> 0, r, i);
			},
			__wbg_requestAdapter_2e6718811c735a57: function(e, t) {
				return x(B(e).requestAdapter(B(t)));
			},
			__wbg_requestDevice_ab46d0519ea1cc34: function(e, t) {
				return x(B(e).requestDevice(B(t)));
			},
			__wbg_resolveQuerySet_0f32dc3de3f09701: function(e, t, n, r, i, a) {
				B(e).resolveQuerySet(B(t), n >>> 0, r >>> 0, B(i), a >>> 0);
			},
			__wbg_resolve_25a7e548d5881dca: function(e) {
				return x(Promise.resolve(B(e)));
			},
			__wbg_scissor_079b7c4a5c9fcb63: function(e, t, n, r, i) {
				B(e).scissor(t, n, r, i);
			},
			__wbg_scissor_e69faa631ab6fdc0: function(e, t, n, r, i) {
				B(e).scissor(t, n, r, i);
			},
			__wbg_setBindGroup_268fd1714fff0ef5: function() {
				return V(function(e, t, n, r, i, a, o) {
					B(e).setBindGroup(t >>> 0, B(n), E(r, i), a, o >>> 0);
				}, arguments);
			},
			...
			__wbg_setBindGroup_c22a1b95c0b17f37: function(e, t, n) {
				B(e).setBindGroup(t >>> 0, B(n));
			},
			__wbg_setBindGroup_f0de6cb2c7dbfc2c: function(e, t, n) {
				B(e).setBindGroup(t >>> 0, B(n));
			},
			__wbg_setIndexBuffer_2531a9103450445e: function(e, t, n, r) {
				B(e).setIndexBuffer(B(t), m[n], r);
			},
			__wbg_setIndexBuffer_7f3cf667b4d71566: function(e, t, n, r, i) {
				B(e).setIndexBuffer(B(t), m[n], r, i);
			},
			...
			__wbg_setStencilReference_66c74be6232bb9da: function(e, t) {
				B(e).setStencilReference(t >>> 0);
			},
			__wbg_setTimeout_b5f25e402b6e8ff9: function() {
				return V(function(e, t, n) {
					return B(e).setTimeout(B(t), n);
				}, arguments);
			},
			__wbg_setVertexBuffer_1e448859663dd400: function(e, t, n, r) {
				B(e).setVertexBuffer(t >>> 0, B(n), r);
			},
			__wbg_setVertexBuffer_7cf533d694e747f3: function(e, t, n, r, i) {
				B(e).setVertexBuffer(t >>> 0, B(n), r, i);
			},
			__wbg_setViewport_d9fc3eac343de7d0: function(e, t, n, r, i, a, o) {
				B(e).setViewport(t, n, r, i, a, o);
			},
			...
			__wbg_set_6f7e2d6e41d9a122: function(e, t, n) {
				B(e)[J(t)] = J(n);
			},
			...
			__wbg_set_buffer_9c01e3b6d6765ea2: function(e, t) {
				B(e).buffer = B(t);
			},
			...
			__wbg_set_bytes_per_row_c54ca96953f35774: function(e, t) {
				B(e).bytesPerRow = t >>> 0;
			},
			...
			__wbg_set_offset_f64_b562d1367e34ef93: function(e, t) {
				B(e).offset = t;
			},
			__wbg_set_offset_f64_fa66068813376ca3: function(e, t) {
				B(e).offset = t;
			},
			__wbg_set_once_27df5233613a51cd: function(e, t) {
				B(e).once = t !== 0;
			},
			...
			__wbg_set_rows_per_image_5011f97318ee71af: function(e, t) {
				B(e).rowsPerImage = t >>> 0;
			},
			...
			__wbg_src_f0e9281991fbd919: function(e, t) {
				let n = B(t).src, r = K(n, $.__wbindgen_export, $.__wbindgen_export2), i = Q;
				k().setInt32(e + 4, i, !0), k().setInt32(e + 0, r, !0);
			},
			__wbg_stack_3b0d974bbf31e44f: function(e, t) {
				let n = B(t).stack, r = K(n, $.__wbindgen_export, $.__wbindgen_export2), i = Q;
				k().setInt32(e + 4, i, !0), k().setInt32(e + 0, r, !0);
			},
			__wbg_static_accessor_GLOBAL_9d53f2689e622ca1: function() {
				let e = t === void 0 ? null : t;
				return W(e) ? 0 : x(e);
			},
			...
			__wbg_texImage2D_01c22558517ee8db: function() {
				return V(function(e, t, n, r, i, a, o) {
					B(e).texImage2D(t >>> 0, n, r, i >>> 0, a >>> 0, B(o));
				}, arguments);
			},
			__wbg_texImage2D_152e9dcd4bc3a464: function() {
				return V(function(e, t, n, r, i, a, o, s, c, l) {
					B(e).texImage2D(t >>> 0, n, r, i, a, o, s >>> 0, c >>> 0, B(l));
				}, arguments);
			},
			...
			__wbg_texImage2D_ea94e8a2df5f97e2: function() {
				return V(function(e, t, n, r, i, a, o, s, c, l) {
					B(e).texImage2D(t >>> 0, n, r, i, a, o, s >>> 0, c >>> 0, l);
				}, arguments);
			},
			...
			__wbg_texParameteri_87ebfcefb0af2c50: function(e, t, n, r) {
				B(e).texParameteri(t >>> 0, n >>> 0, r);
			},
			__wbg_texParameteri_e5ad2054e239066e: function(e, t, n, r) {
				B(e).texParameteri(t >>> 0, n >>> 0, r);
			},
			__wbg_texStorage2D_bb2a1bd1ab0b9184: function(e, t, n, r, i, a) {
				B(e).texStorage2D(t >>> 0, n, r >>> 0, i, a);
			},
			__wbg_texSubImage2D_3483ba5f10ee42c2: function() {
				return V(function(e, t, n, r, i, a, o, s) {
					B(e).texSubImage2D(t >>> 0, n, r, i, a >>> 0, o >>> 0, B(s));
				}, arguments);
			},
			__wbg_texSubImage2D_4ca4c3faa4392438: function() {
				return V(function(e, t, n, r, i, a, o, s, c, l) {
					B(e).texSubImage2D(t >>> 0, n, r, i, a, o, s >>> 0, c >>> 0, B(l));
				}, arguments);
			},
			__wbg_texSubImage2D_54d18572b1ba74ab: function() {
				return V(function(e, t, n, r, i, a, o, s, c, l) {
					B(e).texSubImage2D(t >>> 0, n, r, i, a, o, s >>> 0, c >>> 0, l);
				}, arguments);
			},
			...
			__wbg_then_18f476d590e58992: function(e, t, n) {
				return x(B(e).then(B(t), B(n)));
			},
			__wbg_then_47213a40b6aeb86c: function(e, t) {
				return x(B(e).then(B(t)));
			},
			...
			__wbg_uniform1ui_d177882f473d2afc: function(e, t, n) {
				B(e).uniform1ui(B(t), n >>> 0);
			},
			__wbg_uniform2f_19fb96222ae72e1a: function(e, t, n, r) {
				B(e).uniform2f(B(t), n, r);
			},
			__wbg_uniform2f_44cee47e30b82f96: function(e, t, n, r) {
				B(e).uniform2f(B(t), n, r);
			},
			__wbg_uniform2fv_2f06d989ec4b5d8f: function(e, t, n, r) {
				B(e).uniform2fv(B(t), C(n, r));
			},
			__wbg_uniform2fv_f022309b362a80c3: function(e, t, n, r) {
				B(e).uniform2fv(B(t), C(n, r));
			},
			__wbg_uniform2i_16e8a2c966614be6: function(e, t, n, r) {
				B(e).uniform2i(B(t), n, r);
			},
			__wbg_uniform2i_d353da02172ea38d: function(e, t, n, r) {
				B(e).uniform2i(B(t), n, r);
			},
			__wbg_uniform3f_360c1ea4c73cacef: function(e, t, n, r, i) {
				B(e).uniform3f(B(t), n, r, i);
			},
			__wbg_uniform3f_b616f9e06266a25f: function(e, t, n, r, i) {
				B(e).uniform3f(B(t), n, r, i);
			},
			__wbg_uniform4f_f1a670d511b34878: function(e, t, n, r, i, a) {
				B(e).uniform4f(B(t), n, r, i, a);
			},
			__wbg_uniform4f_f97f3f59af09856f: function(e, t, n, r, i, a) {
				B(e).uniform4f(B(t), n, r, i, a);
			},
			__wbg_uniformMatrix3fv_f45b91f173d7fbed: function(e, t, n, r, i) {
				B(e).uniformMatrix3fv(B(t), n !== 0, C(r, i));
			},
			__wbg_uniformMatrix3fv_feab3f952d705f51: function(e, t, n, r, i) {
				B(e).uniformMatrix3fv(B(t), n !== 0, C(r, i));
			},
			__wbg_uniformMatrix3x2fv_ab13f9742e5fcb2f: function(e, t, n, r, i) {
				B(e).uniformMatrix3x2fv(B(t), n !== 0, C(r, i));
			},
			__wbg_uniformMatrix4fv_540dc6bf792eba8f: function(e, t, n, r, i) {
				B(e).uniformMatrix4fv(B(t), n !== 0, C(r, i));
			},
			__wbg_uniformMatrix4fv_e3dac9dd429d6adc: function(e, t, n, r, i) {
				B(e).uniformMatrix4fv(B(t), n !== 0, C(r, i));
			},
			__wbg_uniformMatrix4x3fv_115d029ad3124cef: function(e, t, n, r, i) {
				B(e).uniformMatrix4x3fv(B(t), n !== 0, C(r, i));
			},
			...
			__wbg_userAgent_8def8135d886414b: function() {
				return V(function(e, t) {
					let n = B(t).userAgent, r = K(n, $.__wbindgen_export, $.__wbindgen_export2), i = Q;
					k().setInt32(e + 4, i, !0), k().setInt32(e + 0, r, !0);
				}, arguments);
			},
			...
			__wbg_vertexAttrib4f_6444504b25f4d43e: function(e, t, n, r, i, a) {
				B(e).vertexAttrib4f(t >>> 0, n, r, i, a);
			},
			__wbg_vertexAttrib4f_aad41fe000407191: function(e, t, n, r, i, a) {
				B(e).vertexAttrib4f(t >>> 0, n, r, i, a);
			},
			__wbg_vertexAttribIPointer_ed1c3507e84527e2: function(e, t, n, r, i, a) {
				B(e).vertexAttribIPointer(t >>> 0, n, r >>> 0, i, a);
			},
			__wbg_vertexAttribPointer_39eddea7c20e350c: function(e, t, n, r, i, a, o) {
				B(e).vertexAttribPointer(t >>> 0, n, r >>> 0, i !== 0, a, o);
			},
			__wbg_vertexAttribPointer_3bc50c0431082f73: function(e, t, n, r, i, a, o) {
				B(e).vertexAttribPointer(t >>> 0, n, r >>> 0, i !== 0, a, o);
			},
			__wbg_videoFrameToken_6f05524e85fa2b75: function(e) {
				return l(B(e));
			},
			__wbg_videoHeight_e267fd1e74bb1b06: function(e) {
				return B(e).videoHeight;
			},
			__wbg_videoWidth_670b8e775ea04b5d: function(e) {
				return B(e).videoWidth;
			},
			__wbg_viewport_14d947f2faf58e85: function(e, t, n, r, i) {
				B(e).viewport(t, n, r, i);
			},
			__wbg_viewport_24055b0754803788: function(e, t, n, r, i) {
				B(e).viewport(t, n, r, i);
			},
			...
			__wbg_writeTexture_53ba204c494b042c: function() {
				return V(function(e, t, n, r, i, a) {
					B(e).writeTexture(B(t), D(n, r), B(i), B(a));
				}, arguments);
			},
			...
			__wbindgen_cast_000000000000000a: function(e) {
				return x(e);
			},
			...
			__wbindgen_cast_0000000000000013: function(e) {
				return x(BigInt.asUintN(64, e));
			},
			__wbindgen_cast_0000000000000014: function(e, t) {
				var n = D(e, t).slice();
				return $.__wbindgen_export4(e, t * 1, 1), x(n);
			},
...
function he(e, t) {
	$.__wasm_bindgen_func_elem_12558(e, t);
}
function ge(e, t, n) {
	$.__wasm_bindgen_func_elem_5127(e, t, x(n));
}
function _e(e, t, n) {
	$.__wasm_bindgen_func_elem_11151(e, t, x(n));
}
function ve(e, t, n) {
	try {
		let i = $.__wbindgen_add_to_stack_pointer(-16);
		$.__wasm_bindgen_func_elem_14195(i, e, t, x(n));
		var r = k().getInt32(i + 0, !0);
		if (k().getInt32(i + 4, !0)) throw J(r);
	} finally {
		$.__wbindgen_add_to_stack_pointer(16);
	}
}
function ye(e, t, n) {
	try {
		let i = $.__wbindgen_add_to_stack_pointer(-16);
		$.__wasm_bindgen_func_elem_11150(i, e, t, x(n));
		var r = k().getInt32(i + 0, !0);
		if (k().getInt32(i + 4, !0)) throw J(r);
	} finally {
		$.__wbindgen_add_to_stack_pointer(16);
...
function be(e, t, n) {
	try {
		let i = $.__wbindgen_add_to_stack_pointer(-16);
		$.__wasm_bindgen_func_elem_11150_3(i, e, t, x(n));
		var r = k().getInt32(i + 0, !0);
		if (k().getInt32(i + 4, !0)) throw J(r);
	} finally {
		$.__wbindgen_add_to_stack_pointer(16);
...
function xe(e, t, n) {
	try {
		let i = $.__wbindgen_add_to_stack_pointer(-16);
		$.__wasm_bindgen_func_elem_11150_5(i, e, t, x(n));
		var r = k().getInt32(i + 0, !0);
		if (k().getInt32(i + 4, !0)) throw J(r);
	} finally {
		$.__wbindgen_add_to_stack_pointer(16);
...
function Se(e, t, n) {
	try {
		let i = $.__wbindgen_add_to_stack_pointer(-16);
		$.__wasm_bindgen_func_elem_11150_6(i, e, t, x(n));
		var r = k().getInt32(i + 0, !0);
		if (k().getInt32(i + 4, !0)) throw J(r);
	} finally {
		$.__wbindgen_add_to_stack_pointer(16);
...
function Ce(e, t, n) {
	try {
		let i = $.__wbindgen_add_to_stack_pointer(-16);
		$.__wasm_bindgen_func_elem_11150_7(i, e, t, x(n));
		var r = k().getInt32(i + 0, !0);
		if (k().getInt32(i + 4, !0)) throw J(r);
	} finally {
		$.__wbindgen_add_to_stack_pointer(16);
...
function we(e, t, n, r) {
	$.__wasm_bindgen_func_elem_14197(e, t, x(n), x(r));
}
var Te = [
	"clamp-to-edge",
	"repeat",
	...
	"storage",
	"read-only-storage"
], Ae = ["opaque", "premultiplied"], je = ["standard", "extended"], Me = [
	"never",
	"less",
	"equal",
	"less-equal",
	...
	"front",
	"back"
], Pe = ["unknown", "destroyed"], Fe = [
	"validation",
	"out-of-memory",
	"internal"
], Ie = ["nearest", "linear"], Le = ["ccw", "cw"], m = ["uint16", "uint32"], h = ["load", "clear"], Re = ["nearest", "linear"], ze = ["low-power", "high-performance"], Be = [
	"point-list",
	"line-list",
	"line-strip",
	"triangle-list",
	"triangle-strip"
], Ve = ["occlusion", "timestamp"], He = [
	"filtering",
	"non-filtering",
	"comparison"
], g = [
	...
	"cube-array",
	"3d"
], Ke = /* @__PURE__ */ "uint8.uint8x2.uint8x4.sint8.sint8x2.sint8x4.unorm8.unorm8x2.unorm8x4.snorm8.snorm8x2.snorm8x4.uint16.uint16x2.uint16x4.sint16.sint16x2.sint16x4.unorm16.unorm16x2.unorm16x4.snorm16.snorm16x2.snorm16x4.float16.float16x2.float16x4.float32.float32x2.float32x3.float32x4.uint32.uint32x2.uint32x3.uint32x4.sint32.sint32x2.sint32x3.sint32x4.unorm10-10-10-2.unorm8x4-bgra".split("."), qe = ["vertex", "instance"], Je = [
	"same-origin",
	"no-cors",
	"cors",
	"navigate"
	...
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((e) => $.__wbg_devicelostpromise_free(e, 1)), Xe = typeof FinalizationRegistry > "u" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((e) => $.__wbg_engine_free(e, 1)), Ze = typeof FinalizationRegistry > "u" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((e) => $.__wbg_pixelreadpromise_free(e, 1)), Qe = typeof FinalizationRegistry > "u" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((e) => $.__wbg_scenecontroller_free(e, 1));
function x(e) {
...
function $e(e) {
	if (q == 1) throw Error("out of js stack");
	return H[--q] = e, q;
}
var et = typeof FinalizationRegistry > "u" ? {
	register: () => {},
	unregister: () => {}
} : new FinalizationRegistry((e) => $.__wbindgen_export5(e.a, e.b));
function S(e) {
	let t = typeof e;
...
function C(e, t) {
	return e >>>= 0, st().subarray(e / 4, e / 4 + t);
}
function nt(e, t) {
	return e >>>= 0, ct().subarray(e / 8, e / 8 + t);
}
function rt(e, t) {
	return e >>>= 0, lt().subarray(e / 2, e / 2 + t);
}
function it(e, t) {
	return e >>>= 0, ut().subarray(e / 4, e / 4 + t);
}
function at(e, t) {
...
function w(e, t) {
	e >>>= 0;
	let n = k(), r = [];
	for (let i = e; i < e + 4 * t; i += 4) r.push(J(n.getUint32(i, !0)));
	return r;
}
function T(e, t) {
	e >>>= 0;
...
function ot(e, t) {
	return e >>>= 0, ft().subarray(e / 2, e / 2 + t);
}
function E(e, t) {
	return e >>>= 0, pt().subarray(e / 4, e / 4 + t);
}
function D(e, t) {
...
var O = null;
function k() {
	return (O === null || O.buffer.detached === !0 || O.buffer.detached === void 0 && O.buffer !== $.memory.buffer) && (O = new DataView($.memory.buffer)), O;
}
var A = null;
function st() {
	return (A === null || A.byteLength === 0) && (A = new Float32Array($.memory.buffer)), A;
}
var j = null;
function ct() {
...
var M = null;
function lt() {
	return (M === null || M.byteLength === 0) && (M = new Int16Array($.memory.buffer)), M;
}
var N = null;
function ut() {
	return (N === null || N.byteLength === 0) && (N = new Int32Array($.memory.buffer)), N;
}
var P = null;
function dt() {
	return (P === null || P.byteLength === 0) && (P = new Int8Array($.memory.buffer)), P;
}
function F(e, t) {
	return gt(e >>> 0, t);
}
var I = null;
function ft() {
	return (I === null || I.byteLength === 0) && (I = new Uint16Array($.memory.buffer)), I;
}
var L = null;
function pt() {
	return (L === null || L.byteLength === 0) && (L = new Uint32Array($.memory.buffer)), L;
}
var R = null;
function z() {
	return (R === null || R.byteLength === 0) && (R = new Uint8Array($.memory.buffer)), R;
}
function B(e) {
	return H[e];
}
...
function G(e, t, n) {
	...
	return i._wbg_cb_unref = () => {
		--r.cnt === 0 && ($.__wbindgen_export5(r.a, r.b), r.a = 0, et.unregister(r));
	}, et.register(i, r, r), i;
}
function mt(e, t) {
	let n = t(e.length * 4, 4) >>> 0, r = k();
	for (let t = 0; t < e.length; t++) r.setUint32(n + 4 * t, x(e[t]), !0);
	return Q = e.length, n;
}
function K(e, t, n) {
	if (n === void 0) {
	...
	if (o !== r) {
		...
		let t = z().subarray(i + o, i + r), a = Z.encodeInto(e, t);
...
Y.decode();
var ht = 2146435072, X = 0;
function gt(e, t) {
	return X += t, X >= ht && (Y = new TextDecoder("utf-8", {
		ignoreBOM: !0,
		fatal: !0
	}), Y.decode(), X = t), Y.decode(z().subarray(e, e + t));
}
...
var Q = 0, $;
function _t(e, t) {
	return $ = e.exports, O = null, A = null, j = null, M = null, N = null, P = null, I = null, L = null, R = null, $.__wbindgen_start(), $;
}
...
function yt(e) {
	...
	let t = me();
	return e instanceof WebAssembly.Module || (e = new WebAssembly.Module(e)), _t(new WebAssembly.Instance(e, t), e);
}
async function bt(e) {
	if ($ !== void 0) return $;
	...
	let { instance: n, module: r } = await vt(await e, t);
	return _t(n, r);
}
//#endregion
export { d as DeviceLostPromise, f as Engine, p as PixelReadPromise, ae as SceneController, oe as addRealizedChild, se as componentInstanceRefreshOps, bt as default, ce as dematerializeInstance, le as duplicateComponentInstance, yt as initSync, ue as overrideForRealizedEdit, de as realizeComponentInstance, fe as removeRealizedNode, pe as web_init };
