...
var r = /* @__PURE__ */ e(((e) => {
	t(), (function() {
		...
		t.prototype = {
			...
			volume: function(e) {
				var t = this || r;
				if (e = parseFloat(e), t.ctx || d(), e !== void 0 && e >= 0 && e <= 1) {
			...
			mute: function(e) {
				var t = this || r;
				t.ctx || d(), t._muted = e, t.usingWebAudio && t.masterGain.gain.setValueAtTime(e ? 0 : t._volume, r.ctx.currentTime);
				for (var n = 0; n < t._howls.length; n++) if (!t._howls[n]._webAudio) for (var i = t._howls[n]._getSoundIds(), a = 0; a < i.length; a++) {
					var o = t._howls[n]._soundById(i[a]);
			...
			_setupCodecs: function() {
				...
				var n = t.canPlayType("audio/mpeg;").replace(/^no$/, ""), i = e._navigator ? e._navigator.userAgent : "", a = i.match(/OPR\/([0-6].)/g), o = a && parseInt(a[0].split("/")[1], 10) < 33, s = i.indexOf("Safari") !== -1 && i.indexOf("Chrome") === -1, c = i.match(/Version\/(.*?) /), l = s && c && parseInt(c[1], 10) < 15;
				return e._codecs = {
		...
		i.prototype = {
			...
			load: function() {
				var e = this, t = null;
				if (r.noAudio) return void e._emit("loaderror", null, "No audio support.");
				typeof e._src == "string" && (e._src = [e._src]);
				for (var n = 0; n < e._src.length; n++) {
					var i, o;
					if (e._format && e._format[n]) i = e._format[n];
					else {
						if (typeof (o = e._src[n]) != "string") {
							e._emit("loaderror", null, "Non-string found in selected audio sources - ignoring.");
							continue;
						}
						i = /^data:audio\/([^;,]+);/i.exec(o), i ||= /\.([^.]+)$/.exec(o.split("?", 1)[0]), i &&= i[1].toLowerCase();
					}
				...
				return t ? (e._src = t, e._state = "loading", window.location.protocol === "https:" && t.slice(0, 5) === "http:" && (e._html5 = !0, e._webAudio = !1), new a(e), e._webAudio && s(e), e) : void e._emit("loaderror", null, "No codec support for selected audio sources.");
			},
			play: function(e, t) {
				var n = this, i = null;
				if (typeof e == "number") i = e, e = null;
					...
					if (e === void 0 && (e = "__default", !n._playLock)) {
				...
				if (!s) return null;
				if (i && !e && (e = s._sprite || "__default"), n._state !== "loaded") {
				...
				var l = Math.max(0, s._seek > 0 ? s._seek : n._sprite[e][0] / 1e3), u = Math.max(0, (n._sprite[e][0] + n._sprite[e][1]) / 1e3 - l), d = 1e3 * u / Math.abs(s._rate), f = n._sprite[e][0] / 1e3, p = (n._sprite[e][0] + n._sprite[e][1]) / 1e3;
				s._sprite = e, s._ended = !1;
				var m = function() {
					s._paused = !1, s._seek = l, s._start = f, s._stop = p, s._loop = !(!s._loop && !n._sprite[e][2]);
				};
				if (l >= p) return void n._ended(s);
				var h = s._node;
				if (n._webAudio) {
					var g = function() {
						n._playLock = !1, m(), n._refreshBuffer(s);
						var e = s._muted || n._muted ? 0 : s._volume;
						h.gain.setValueAtTime(e, r.ctx.currentTime), s._playStart = r.ctx.currentTime, h.bufferSource.start === void 0 ? s._loop ? h.bufferSource.noteGrainOn(0, l, 86400) : h.bufferSource.noteGrainOn(0, l, u) : s._loop ? h.bufferSource.start(0, l, 86400) : h.bufferSource.start(0, l, u), d !== 1 / 0 && (n._endTimers[s._id] = setTimeout(n._ended.bind(n, s), d)), t || setTimeout(function() {
							n._emit("play", s._id), n._loadQueue();
						}, 0);
					};
					r.state === "running" && r.ctx.state !== "interrupted" ? g() : (n._playLock = !0, n.once("resume", g), n._clearTimer(s._id));
				} else {
					var _ = function() {
						h.currentTime = l, h.muted = s._muted || n._muted || r._muted || h.muted, h.volume = s._volume * r.volume(), h.playbackRate = s._rate;
						try {
							var i = h.play();
							if (i && typeof Promise < "u" && (i instanceof Promise || typeof i.then == "function") ? (n._playLock = !0, m(), i.then(function() {
							...
							})) : t || (n._playLock = !1, m(), n._emit("play", s._id)), h.playbackRate = s._rate, h.paused) return void n._emit("playerror", s._id, "Playback was unable to start. This is most commonly an issue on mobile devices and Chrome where playback was not within a user interaction.");
							e !== "__default" || s._loop ? n._endTimers[s._id] = setTimeout(n._ended.bind(n, s), d) : (n._endTimers[s._id] = function() {
					...
					if (h.readyState >= 3 || v) _();
						...
						var y = function() {
							n._state = "loaded", _(), h.removeEventListener(r._canPlayEvent, y, !1);
						};
						h.addEventListener(r._canPlayEvent, y, !1), n._clearTimer(s._id);
					}
				}
				return s._id;
			},
			...
			mute: function(e, t) {
				...
				if (t === void 0) {
					if (typeof e != "boolean") return n._muted;
					n._muted = e;
				}
			...
			volume: function() {
				...
				if (i.length === 0) return n._volume;
				i.length === 1 || i.length === 2 && i[1] === void 0 ? n._getSoundIds().indexOf(i[0]) >= 0 ? t = parseInt(i[0], 10) : e = parseFloat(i[0]) : i.length >= 2 && (e = parseFloat(i[0]), t = parseInt(i[1], 10));
				var a;
				if (!(e !== void 0 && e >= 0 && e <= 1)) return a = t ? n._soundById(t) : n._sounds[0], a ? a._volume : 0;
				if (n._state !== "loaded" || n._playLock) return n._queue.push({
					event: "volume",
					action: function() {
						n.volume.apply(n, i);
				...
				t === void 0 && (n._volume = e), t = n._getSoundIds(t);
				for (var o = 0; o < t.length; o++) (a = n._soundById(t[o])) && (a._volume = e, i[2] || n._stopFade(t[o]), n._webAudio && a._node && !a._muted ? a._node.gain.setValueAtTime(e, r.ctx.currentTime) : a._node && !a._muted && (a._node.volume = e * r.volume()), n._emit("volume", a._id));
				return n;
			},
			...
			rate: function() {
				var e, t, n = this, i = arguments;
				i.length === 0 ? t = n._sounds[0]._id : i.length === 1 ? n._getSoundIds().indexOf(i[0]) >= 0 ? t = parseInt(i[0], 10) : e = parseFloat(i[0]) : i.length === 2 && (e = parseFloat(i[0]), t = parseInt(i[1], 10));
				var a;
				if (typeof e != "number") return a = n._soundById(t), a ? a._rate : n._rate;
				if (n._state !== "loaded" || n._playLock) return n._queue.push({
					event: "rate",
					action: function() {
						n.rate.apply(n, i);
				...
				t === void 0 && (n._rate = e), t = n._getSoundIds(t);
				for (var o = 0; o < t.length; o++) if (a = n._soundById(t[o])) {
					n.playing(t[o]) && (a._rateSeek = n.seek(t[o]), a._playStart = n._webAudio ? r.ctx.currentTime : a._playStart), a._rate = e, n._webAudio && a._node && a._node.bufferSource ? a._node.bufferSource.playbackRate.setValueAtTime(e, r.ctx.currentTime) : a._node && (a._node.playbackRate = e);
					var s = n.seek(t[o]), c = 1e3 * ((n._sprite[a._sprite][0] + n._sprite[a._sprite][1]) / 1e3 - s) / Math.abs(a._rate);
					!n._endTimers[t[o]] && a._paused || (n._clearTimer(t[o]), n._endTimers[t[o]] = setTimeout(n._ended.bind(n, a), c)), n._emit("rate", a._id);
				}
				return n;
			},
			seek: function() {
				var e, t, n = this, i = arguments;
				if (i.length === 0 ? n._sounds.length && (t = n._sounds[0]._id) : i.length === 1 ? n._getSoundIds().indexOf(i[0]) >= 0 ? t = parseInt(i[0], 10) : n._sounds.length && (t = n._sounds[0]._id, e = parseFloat(i[0])) : i.length === 2 && (e = parseFloat(i[0]), t = parseInt(i[1], 10)), t === void 0) return 0;
				if (typeof e == "number" && (n._state !== "loaded" || n._playLock)) return n._queue.push({
					event: "seek",
					action: function() {
						n.seek.apply(n, i);
					}
				...
				if (a) {
					if (!(typeof e == "number" && e >= 0)) {
						if (n._webAudio) {
							var o = n.playing(t) ? r.ctx.currentTime - a._playStart : 0, s = a._rateSeek ? a._rateSeek - a._seek : 0;
			...
			_ended: function(e) {
				...
				return t._webAudio && !i && (e._paused = !0, e._ended = !0, e._seek = e._start || 0, e._rateSeek = 0, t._clearTimer(e._id), t._cleanBuffer(e._node), r._autoSuspend()), t._webAudio || i || t.stop(e._id, !0), t;
			},
			...
			_refreshBuffer: function(e) {
				var t = this;
				return e._node.bufferSource = r.ctx.createBufferSource(), e._node.bufferSource.buffer = o[t._src], e._panner ? e._node.bufferSource.connect(e._panner) : e._node.bufferSource.connect(e._node), e._node.bufferSource.loop = e._loop, e._loop && (e._node.bufferSource.loopStart = e._start || 0, e._node.bufferSource.loopEnd = e._stop || 0), e._node.bufferSource.playbackRate.setValueAtTime(e._rate, r.ctx.currentTime), t;
			},
		...
		a.prototype = {
			...
			create: function() {
				...
				return t._webAudio ? (e._node = r.ctx.createGain === void 0 ? r.ctx.createGainNode() : r.ctx.createGain(), e._node.gain.setValueAtTime(n, r.ctx.currentTime), e._node.paused = !0, e._node.connect(r.masterGain)) : r.noAudio || (e._node = r._obtainHtml5Audio(), e._errorFn = e._errorListener.bind(e), e._node.addEventListener("error", e._errorFn, !1), e._loadFn = e._loadListener.bind(e), e._node.addEventListener(r._canPlayEvent, e._loadFn, !1), e._endFn = e._endListener.bind(e), e._node.addEventListener("ended", e._endFn, !1), e._node.src = t._src, e._node.preload = !0 === t._preload ? "auto" : t._preload, e._node.volume = n * r.volume(), e._node.load()), e;
			},
			reset: function() {
				var e = this, t = e._parent;
			...
			_loadListener: function() {
				var e = this, t = e._parent;
				t._duration = Math.ceil(10 * e._node.duration) / 10, Object.keys(t._sprite).length === 0 && (t._sprite = { __default: [0, 1e3 * t._duration] }), t._state !== "loaded" && (t._state = "loaded", t._emit("load"), t._loadQueue()), e._node.removeEventListener(r._canPlayEvent, e._loadFn, !1);
			},
		...
		var o = {}, s = function(e) {
			...
			if (/^data:[^;]+;base64,/.test(t)) {
				...
				a.open(e._xhr.method, t, !0), a.withCredentials = e._xhr.withCredentials, a.responseType = "arraybuffer", e._xhr.headers && Object.keys(e._xhr.headers).forEach(function(t) {
					...
					var t = (a.status + "")[0];
					if (t !== "0" && t !== "2" && t !== "3") return void e._emit("loaderror", null, "Failed loading audio file with status: " + a.status + ".");
					l(a.response, e);
				}, a.onerror = function() {
			...
			var n = function() {
				...
				e && t._sounds.length > 0 ? (o[t._src] = e, u(t, e)) : n();
			};
			typeof Promise < "u" && r.ctx.decodeAudioData.length === 1 ? r.ctx.decodeAudioData(e).then(i).catch(n) : r.ctx.decodeAudioData(e, i, n);
		}, u = function(e, t) {
		...
		}), e !== void 0 && (e.Howler = r, e.Howl = i), n === void 0 ? typeof window < "u" && (window.HowlerGlobal = t, window.Howler = r, window.Howl = i, window.Sound = a) : (n.HowlerGlobal = t, n.Howler = r, n.Howl = i, n.Sound = a);
	})();
}));
//#endregion
export default r();
